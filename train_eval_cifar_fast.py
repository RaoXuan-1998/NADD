...
parser.add_argument('--save', type = str, default = '5F-E-CIFAR-31-DA-E47-CIFAR-R3')
parser.add_argument('--load_geno_path', type = str, default = 'S-CIFAR-31-DA-3op-small_T_A/genotypes/epoch_47,geno.npy')
...
parser.add_argument('--learning_rate_network', type = float, default = 0.05)
...
parser.add_argument('--auto_augment', default = True)
...
parser.add_argument('--count_flops', type = bool, default = False)
...
def main():
    ...
    network = Network_Cifar(args.channels, args.auxiliary, args.num_classes, network_genotype).cuda()
    ...
    scheduler_network = torch.optim.lr_scheduler.CosineAnnealingLR(
        optimizer_network,float(args.epochs))
    ...
    for epoch in range(args.epochs):
        ...
        drop_prob = drop_prob_max*epoch/args.epochs
