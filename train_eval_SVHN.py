...
parser.add_argument('--save', type = str, default = 'E-ImageNet-05-D-Step114000-SVHN-R21')
parser.add_argument('--load_geno_path', type = str, default = 'S-ImageNet-05-Distillation/genotypes/step_114000,geno.npy')
parser.add_argument('--cells_num', type = int, default = 14)
parser.add_argument('--data', type = str, default = '../../data/SVHN')
...
parser.add_argument('--learning_rate_network', type = float, default = 0.1)
